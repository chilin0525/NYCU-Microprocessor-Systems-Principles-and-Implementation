...
HD_PWD='/home/chilin/emb/HW4/aquila_sd/aquila_sd.runs/async_fifo_addr_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log async_fifo_addr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source async_fifo_addr.tcl
